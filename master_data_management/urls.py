...
urlpatterns = [
    ...
    # User Status URL (Here we have keep the user_id and status_id)
    path('v1/user-status', views.UserStatusListCreate.as_view(), name='user_status_list_create'),
    path('v1/user-status/<int:pk>', views.UserStatusDetailAPIView.as_view(), name='user_status_detail'),
    ...
    # Legal Entity URL
    path('v1/legal-entity', views.LegalEntityCreateApi.as_view(), name='legal_entity_create'),
    path('v1/legal-entity/<int:pk>', views.LegalEntityModifyApi.as_view(), name='legal_entity_modify'),
    path('v1/legal-entity/list', views.LegalEntityFilterApi.as_view(), name='legal_entity_filter'),

    # Vendor Search URL
    path('v1/vendor/list', views.VendorFilterApi.as_view(), name='vendor_list'),
    path('v1/vendor', views.VendorCreateApi.as_view(), name='vendor_create'),
    path('v1/vendor/<int:pk>', views.VendorUpdateApi.as_view(), name='vendor_update'),
    ...
    # path('v1/file-type/list', views.FileTypeFilterApi.as_view(), name='file_type_list'),
    ...
    # destinationreview url
    # path('v1/destination-review', views.DestinationReviewListCreateApi.as_view(), name='destination_review_list_create'),
    # path('v1/destination-review/<int:pk>', views.DestinationReviewRetrieveUpdateDestroyApi.as_view(), name='destination_review_detail'),
]
