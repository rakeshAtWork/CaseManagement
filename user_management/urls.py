...
urlpatterns = [
    ...
    path('v1/<int:id>', views.UserUpdateApi.as_view(), name='user_detail_update'),
    # This for update the User Information field along with its role.
    path('v1/profile', views.CurrentUserProfileApi.as_view(), name='user_profile'),
    ...
    # User Json-info is listed in the above API.(Unit test case written for json-info)
