...
from case_management.utility import ModuleEnum, BaseModel
...
class RolePermission(models.Model):
    ...
    created_on = models.DateTimeField(auto_now_add=True)
    modified_by = models.ForeignKey(User, null=True, blank=True, on_delete=models.CASCADE,
                                    related_name="role_privilege_modified_by")
    modified_on = models.DateTimeField(null=True)
...
class MasterModule(BaseModel):
    module_id = models.PositiveIntegerField(choices=ModuleEnum.choices(), primary_key=True)
