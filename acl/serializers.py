...
from .models import (Role, RolePermission, MasterPrivilege, AppConfiguration, MasterModule, )
...
class RoleReadSerializer(serializers.ModelSerializer):
    ...
    modified_by = serializers.CharField(source='modified_by.first_name', allow_null=True)
    ...
    def get_privilege_names(self, obj):
        ...
        return [
            {
                "privilege_name": privilege.privilege.privilege_name,
                "module_id": privilege.privilege.module_id
            }
