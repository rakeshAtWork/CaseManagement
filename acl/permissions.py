...
permission_role_create = namespace.add_permission(
    privilege_desc=_('New Role is created successfully!'), privilege_name='CREATE_ROLE', module_id=140
)
permission_role_list = namespace.add_permission(
    privilege_desc=_('Viewed all Roles!'), privilege_name='VIEW_ROLE_LIST', module_id=140
)
permission_role_view = namespace.add_permission(
    privilege_desc=_('Viewed a specific Role details!'), privilege_name='VIEW_ROLE', module_id=140
)
...
permission_role_delete = namespace.add_permission(
    privilege_desc=_('Role is deleted!'), privilege_name='DELETE_ROLE', module_id=140
)
...
permission_client_permission_list = namespace.add_permission(
    ...
    privilege_name='VIEW_CLIENT_PERMISSION_LIST', module_id=20
)
permission_client_permission_view = namespace.add_permission(
    privilege_desc=_('View  permissions for a Client!'),
    privilege_name='VIEW_CLIENT_PERMISSION', module_id=20
)
permission_client_permission_edit = namespace.add_permission(
    ...
    privilege_name='UPDATE_CLIENT_PERMISSION', module_id=20
)
permission_client_permission_delete = namespace.add_permission(
    ...
    privilege_name='DELETE_CLIENT_PERMISSION', module_id=20
)
