...
urlpatterns = [
    path('v1/role/list/filter', views.RoleFilterApi.as_view(), name='role_list'),
    ...
    path('v1/privilege/create', views.PopulatePermissionsView.as_view(), name="populate_privileges"),
