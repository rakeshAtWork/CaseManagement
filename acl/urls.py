...
urlpatterns = [
    ...
    path('v1/role-assign/user', views.RoleUserCreateAPI.as_view(), name='role_user_create'),
    ...
    path('v1/privilege-delete', views.DeleteAllPrivilegesApiView.as_view(), name='delete-all-privileges'),
    ...
    path('v1/modules', views.MasterModuleListCreateView.as_view(), name='module_list'),
    path('v1/modules-populate', views.PopulateMasterModuleView.as_view(), name='populate_master_module'),
